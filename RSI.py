...
"""
main function that runs the RSI algorithm
returns:
	b: buy
	s: sell
	n: neither
...
def mainRSI():
	...
	entry_threshold = raw_input('Enter the Entry Threshold: ') 
	n_days = raw_input('Enter the n-day RSI, where n is an integer: ')
	init(aggData)
	rsi = RSI(n_days)
