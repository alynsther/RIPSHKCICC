...
urllib.urlretrieve("http://www.businessweek.com/archive/2015-02/bbg.html", "foobar.html")
html = open("foobar.html").read()
s = html2text.html2text(html)
print(s)

#bug: regardless of character, prints the same results. 
starting_place = s.find("#### February 01, 2015")
ending_place = s.find("Terms of Service", starting_place)
