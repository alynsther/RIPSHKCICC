...
def generate_date_p():
    ...
    start_year, start_month, start_day = 2009, 1, 1
...
def price_finder_csv(indices):
    ...
    for i in indices:
        ...
        elif datelist[i + 4] in csvdatelist:
            price_vector.append(price_change[csvdatelist.index(datelist[i + 4])])
        elif datelist[i + 5] in csvdatelist:
            price_vector.append(price_change[csvdatelist.index(datelist[i + 5])])
